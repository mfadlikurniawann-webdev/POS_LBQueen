        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-gray-100 p-8 lg:p-10">
              ...
              <div>
                ...
                <div className="relative">
                  <input type={showPass ? "text" : "password"} required value={password} onChange={e => setPassword(e.target.value)}
                    placeholder="••••••••"
                    className="w-full px-4 py-3.5 bg-gray-50 border-2 border-gray-100 rounded-xl text-sm font-medium focus:bg-white focus:border-[#C94F78] focus:ring-4 focus:ring-[#C94F78]/10 outline-none transition-all pr-14" />
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
               <a href="/customer-portal/login" className="text-[#C94F78] font-bold text-xs hover:underline uppercase tracking-wide">Portal Pelanggan →</a>
            </div>
          </div>
        </div>
      </div>
