  ...
  return (
    <div className="min-h-screen bg-[#FDFCFD] pb-32">
      ...
      <div className="sticky top-0 z-50 bg-[#C94F78] px-5 pt-12 pb-6 border-b border-[#C94F78]/10 text-white">
        ...
        <p className="text-[11px] font-semibold opacity-80 capitalize tracking-widest pl-14">Penawaran Eksklusif LBQueen</p>
      </div>
      ...
      <div className="p-5">
        {loading ? (
          <div className="py-20 flex flex-col items-center gap-4">
             ...
             <p className="text-xs font-semibold text-gray-300 capitalize tracking-widest">Mencari Diskon Terbaik...</p>
          </div>
        ) : products.length === 0 ? (
          <div className="py-20 text-center flex flex-col items-center gap-6">
             ...
             <div>
                ...
                <Link href="/customer-portal" className="bg-[#C94F78] text-white px-8 py-3 rounded-full font-semibold text-sm tracking-widest capitalize shadow-lg">
                   Eksplor Layanan
                </Link>
             </div>
          </div>
              ...
              return (
                <div key={product.id} className="bg-white rounded-[32px] overflow-hidden border border-gray-50 shadow-md group active:scale-[0.98] transition-all">
                   <div className="relative aspect-[16/8] overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 bg-[#C94F78] text-white px-4 py-1.5 rounded-full text-[10px] font-semibold capitalize tracking-widest shadow-lg flex items-center gap-2">
                   ...
                   <div className="p-6">
                      <div className="flex justify-between items-start mb-4">
                         <div>
                            ...
                            <p className="text-[10px] font-semibold text-gray-400 capitalize tracking-widest">{product.type}</p>
                         </div>
                      ...
                      <div className="flex items-end justify-between">
                         ...
                         <Link href={`/customer-portal`} className="h-12 px-6 bg-[#C94F78] text-white rounded-2xl font-semibold text-[11px] capitalize tracking-widest flex items-center justify-center gap-2 active:scale-95 transition-all shadow-lg shadow-rose-100">
